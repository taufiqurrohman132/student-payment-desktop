...
class Pembayaran(ctk.CTkFrame):
    ...
    def create_widgets(self):
        ...
        # Daftar Tagihan
        self.add_semester_section("Semester 5", [("Ujian susulan", "2019/2020 Ganjil", "Rp300.000", "300.000")])
        self.add_semester_section("Semester 6", [
            ("BPP Pokok SP", "2019/2020 Genap", "Rp1.350.000", "1.350.000"),
            ("Biaya Bulanan", "2019/2020 Genap - Februari", "Rp400.000", "0")
        ])
    ...
    def add_semester_section(self, title, items):
        ...
        for item in items:
            ...
            ctk.CTkCheckBox(frame, text=item[0]).pack(side="left", padx=5)
            ctk.CTkLabel(frame, text=item[1]).pack(side="left", padx=5)
            ctk.CTkLabel(frame, text=item[2]).pack(side="left", padx=5)
            ctk.CTkEntry(frame, width=100, placeholder_text="Jumlah Bayar", justify="right").pack(side="left", padx=5)
            ctk.CTkButton(frame, text="Isi Tunggakan", width=100).pack(side="right", padx=10)
